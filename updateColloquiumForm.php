...
function updateCol($title, $time, $date, $location, $presentor, $description)
{
...
<br><br><br><br><br><br><br>
  ...
  <div class ="info"  id = "whiteBox">
    ...
    <?php
	echo "<form  action='updateColloquiumForm.php?title=$titleRemove' method='POST' enctype='multipart/form-data'>" ?>
   ...
   <?php
	echo "<form action='updateColloquiumForm.php?title=$titleRemove' method='POST'>";
    echo "<input type='submit' name='delete' value='delete'>";
    echo '</form> ';

?> 
    <form action="updateColloquiumForm.php" method="POST">
	...
	else if(isset($_POST['send']))
	{
		...
		if(empty($_POST['description'])) 
  		...
  		if(empty($errorMessage)) 
  		{
				...
				updateCol($title, $time, $date, $location, $presenter, $description);
				header("Location: Colloquium.php");
